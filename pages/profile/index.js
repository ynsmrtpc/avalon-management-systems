    ...
    <HomeLayout>
      <div className="grid mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 mx-auto gap-5">
          <div className="bg-white rounded-md dark:bg-card_bg_dark lg:flex lg:justify-start lg:items-center col-span-12 md:col-span-6">
            <img
            ...
            <div className="sm:flex sm:flex-col sm:items-center grid grid-cols-1 mx-auto">
              ...
              <button className="p-1 bg-primary_logo_light dark:bg-primary_logo_dark mt-3 md:mt-6 text-center rounded-md flex items-center justify-center">
          ...
          <div className="bg-white rounded-md dark:bg-card_bg_dark px-4 py-8 col-span-12 md:col-span-6">
            <h4 className="text-2xl">
              Social Media{" "}
              {message && (
                <div className="text-sm text-center bg-sky-400 dark:bg-sky-800 dark:text-white text-zinc-700 p-2 rounded w-full">
                  {" "}
                  {message}{" "}
                </div>
              )}{" "}
            ...
            <div className="grid grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 my-8 gap-5 mrd:gap-5 text-center mx-auto">
              {" "}
