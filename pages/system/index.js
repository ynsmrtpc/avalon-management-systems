    ...
    return ( <
        ...
        div className = "p-2" > {
            parentItems.map((parentItem, index) => ( <
                ...
                < i className = "fa fa-angles-down text-indigo-500" > < /i> <
                /button> <
                button type = "button"
                title = "Edit"
                className = "ml-2 border px-1.5 py-0.5 rounded hover:bg-gray-200"
                ...
                className = "ml-2 border px-1.5 py-0.5 rounded hover:bg-gray-200"
                onClick = {
                    () => handleDeleteModule(parentItem.id) } >
                <
                ...
                /summary> {
                    childItems
                        ...
                        .map(childItem => ( <
                            ...
                            className = "p-3 rounded relative mb-0 pb-0 ml-4" >
                            <
                            ...
                            className = "ml-2 border px-1.5 py-0.5 rounded hover:bg-gray-200"
                            onClick = {
                                () => handleDeleteModule(childItem.id) } >
                            <
                            i className = "fa fa-trash text-red-500" > < /i> <
                            /button> <
                            /div> <
...

        {
            showModal && ( <
                >
                <
                Modal title = "Modül Ekle / Düzenle"
                ...
                div className = "col-span-1" >
                <
                CustomInput labelContent = "Queue"
                inputID = "queue"
                type = "number"
