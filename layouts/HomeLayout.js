                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start">
                        ...
                        <Link href="/" className="flex ml-2 md:mr-24">
                            <img src="https://storage.googleapis.com/yunusemretopcu.appspot.com/logo.png" className="h-8 mr-3"
                                 alt="avalon-logo" />
                            <span
                                className="self-center text-xl  font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Avalon Management Systems</span>
                        </Link>
                    </div>
